...
*/
	...
	Round.prototype.destroy = function(){
		...
		while(score.explosion.length > 0){

			var poped = score.explosion.pop()
			poped[0].destroy()
			score.stage.removeChild(poped[0])
			poped = ""

		}

		while(score.stars.length > 0){

			var poped = score.stars.pop()
			poped[0].destroy()
			score.stage.removeChild(poped[0])
			poped = ""
...
*/
	...
	//called once to set up position of score and adding to score varible
